...
public static class SwaggerHelper
{
    ...
    private static OpenApiInfo GetOpenApiInfo(string version, string title = "Auth Service - API")
    {
    ...
    {
        options.SwaggerEndpoint($"/swagger/api/swagger.json", "Auth Service - API");
    }
}
